...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/attend-all-meetings-ii/1?utm=codolio)

## Solved On
25 Aug 2026 at 08:38 pm

<h2><a href="https://www.geeksforgeeks.org/problems/attend-all-meetings-ii/1?utm=codolio">Meeting Rooms II</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 14pt;">Given two arrays&nbsp;<strong>start[] </strong>and<strong> end[]</strong> such that start[i] is the starting time of ith meeting and end[i] is the ending time of ith meeting. Return the <strong>minimum number</strong> of rooms required to attend all meetings.</span></p>
