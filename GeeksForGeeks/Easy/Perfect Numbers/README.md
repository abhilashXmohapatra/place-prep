...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/perfect-numbers3207/1)

## Solved On
29 Jun 2026 at 11:55 pm

<h2><a href="https://www.geeksforgeeks.org/problems/perfect-numbers3207/1">Perfect Numbers</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 14pt;">Given a number <strong>n,</strong> check if the number is <strong>perfect</strong> or not. A number is said to be perfect if <strong>sum</strong> of all its factors excluding the number itself is equal to the <strong>number</strong>.</span></p>
...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong></span><br><span style="font-size: 14pt;">1 ≤ n ≤ 10<sup>9</sup></span></p>