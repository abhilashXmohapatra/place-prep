...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/java-loops-set-11726/1)

## Solved On
26 Jul 2026 at 04:14 pm

<h2><a href="https://www.geeksforgeeks.org/problems/java-loops-set-11726/1">Java loops | Set 1</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size:18px">For a given N, return an arraylist containing&nbsp;the sum of even and odd integers of the first N natural numbers.</span></p>
